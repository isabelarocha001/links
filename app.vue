      ...
      <section class="direct-section">
        ...
        <div class="direct-stack">
          ...
          >
            ...
            <span class="d-btn-text">
              <span class="d-btn-title">WhatsApp privado</span>
              <span class="d-btn-sub">Só venda de conteúdo</span>
            </span>
          </a>
          <a
          ...
          >
            ...
            <span class="d-btn-text">
              <span class="d-btn-title">Telegram privado</span>
              <span class="d-btn-sub">Só venda de conteúdo</span>
            </span>
          </a>
        </div>
